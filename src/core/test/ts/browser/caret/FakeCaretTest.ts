...
import { FakeCaret, isFakeCaretTarget } from 'tinymce/src/core/main/ts/caret/FakeCaret';
...
import { isFakeCaretTableBrowser } from 'tinymce/src/core/main/ts/keyboard/TableNavigation';
