...
UnitTest.asynctest('browser.tinymce.plugins.fullpage.FullPagePluginTest', function () {
    ...
    suite.test('Default header/footer', function (editor) {
        ...
        LegacyUnit.equal(editor.getContent(), '<!DOCTYPE html>\n<html>\n<head>\n</head>\n<body>\n<p>Test</p>\n</body>\n</html>', 'Invalid HTML content is still editable.');
    });
    ...
    suite.test('link elements', function (editor) {
        ...
        LegacyUnit.equal(editor.getContent(), '<html><head><link rel="stylesheet" href="a.css"><link rel="something"></head><body>\n<p>c</p>\n</body></html>');
    });
    ...
    var sParseStyles = function (editor) {
        return GeneralSteps.sequence([
            ...
            Waiter.sTryUntil('Expected styles where not added', Step.sync(function () {
...
//# sourceMappingURL=FullPagePluginTest.js.map