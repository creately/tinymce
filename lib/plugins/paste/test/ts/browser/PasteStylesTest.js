...
UnitTest.asynctest('Browser Test: .PasteStylesTest', function () {
    ...
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        var steps = Env.webkit ? [
            Logger.t('Paste span with encoded style attribute, paste_webkit_styles: font-family', GeneralSteps.sequence([
            ...
            Logger.t('Paste span with encoded style attribute, paste_webkit_styles: all', GeneralSteps.sequence([
            ...
            Logger.t('Paste span with encoded style attribute, paste_webkit_styles: none', GeneralSteps.sequence([
            ...
            Logger.t('Paste span with encoded style attribute, paste_remove_styles_if_webkit: false', GeneralSteps.sequence([
...
//# sourceMappingURL=PasteStylesTest.js.map