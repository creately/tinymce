...
UnitTest.asynctest('browser.tinymce.plugins.media.ContentFormatsTest', function () {
    ...
    suite.test('Object retain as is', function (editor) {
        editor.setContent('<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="425" height="355">' +
            ...
            '</object>');
        LegacyUnit.equal(editor.getContent(), '<p><object width="425" height="355" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000">' +
            '<param name="movie" value="someurl" />' +
            '<param name="wmode" value="transparent" />' +
            '<embed src="someurl" type="application/x-shockwave-flash" wmode="transparent" width="425" height="355" />' +
            '</object></p>');
    ...
    suite.test('Video retain as is', function (editor) {
        ...
        LegacyUnit.equal(editor.getContent(), '<p><video src="320x240.ogg" autoplay="autoplay" loop="loop" controls="controls" width="300" height="150">text<a href="#">link</a></video></p>');
    });
    suite.test('Iframe retain as is', function (editor) {
        ...
        LegacyUnit.equal(editor.getContent(), '<p><iframe src="320x240.ogg" allowfullscreen="allowfullscreen">text<a href="#">link</a></iframe></p>');
    });
    suite.test('Audio retain as is', function (editor) {
        editor.setContent('<audio src="sound.mp3">' +
    ...
    suite.test('Resize complex object', function (editor) {
        editor.setContent('<video width="300" height="150" controls="controls">' +
            '<source src="s" />' +
    ...
    suite.test('Media script elements', function (editor) {
        editor.setContent('<script src="http://media1.tinymce.com/123456"></sc' + 'ript>' +
    ...
    suite.test('XSS content', function (editor) {
        ...
        testXss('<p><video><noscript><svg onload="javascript:alert(1)"></svg></noscript></video>', '<p><video width="300" height="150"></video></p>');
        testXss('<p><video><script><svg onload="javascript:alert(1)"></svg></s' + 'cript></video>', '<p><video width="300" height="150"></video></p>');
...
//# sourceMappingURL=ContentFormatsTest.js.map