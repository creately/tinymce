...
UnitTest.asynctest('browser.core.DataToHtmlTest', function () {
    ...
    var sTestDataToHtml = function (editor, data, expected) {
        ...
        return Waiter.sTryUntil('Wait for structure check', Assertions.sAssertStructure('Assert equal', expected, actual), 10, 500);
    };
...
//# sourceMappingURL=DataToHtmlTest.js.map