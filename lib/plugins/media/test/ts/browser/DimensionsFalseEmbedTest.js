...
UnitTest.asynctest('browser.tinymce.plugins.media.DimensionsFalseEmbedTest', function () {
    ...
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        Pipeline.async({}, [
            ...
            Utils.sPasteTextareaValue(tinyUi, '<iframe width="200" height="100" src="a" ' +
                ' frameborder="0" allowfullscreen></iframe>'),
            Utils.sSubmitDialog(tinyUi),
            Waiter.sTryUntil('content was not expected structure', tinyApis.sAssertContentStructure(struct), 100, 4000)
        ], onSuccess, onFailure);
    }, {
        plugins: ['media'],
        toolbar: 'media',
...
//# sourceMappingURL=DimensionsFalseEmbedTest.js.map