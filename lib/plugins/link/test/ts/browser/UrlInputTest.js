...
var cCloseDialog = Chain.fromChains([
    UiFinder.cFindIn('button:contains("Cancel")'),
    Mouse.cClick
]);
UnitTest.asynctest('browser.tinymce.plugins.link.UrlInputTest', function (success, failure) {
    ModernTheme();
    LinkPlugin();
...
//# sourceMappingURL=UrlInputTest.js.map