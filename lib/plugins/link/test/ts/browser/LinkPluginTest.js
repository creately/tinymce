...
UnitTest.asynctest('browser.tinymce.plugins.link.LinkPluginTest', function () {
    ...
    suite.test('Default link dialog on empty editor', function (editor) {
        ...
        LegacyUnit.equal(cleanHtml(editor.getContent()), '<p><a title="title" href="href" target="_blank" rel="noopener">text</a></p>');
    });
    suite.test('Default link dialog on text selection', function (editor) {
        ...
        LegacyUnit.equal(cleanHtml(editor.getContent()), '<p>a<a title="title" href="href" target="_blank" rel="noopener">b</a>c</p>');
    });
    suite.test('Default link dialog on non pure text selection', function (editor) {
        ...
        LegacyUnit.equal(cleanHtml(editor.getContent()), '<p><a title="title" href="href" target="_blank" rel="noopener">a</a></p>' +
    ...
    suite.test('All lists link dialog on empty editor', function (editor) {
        ...
        LegacyUnit.equal(cleanHtml(editor.getContent()), '<p><a class="class1" title="title" href="href" target="target1" rel="rel1">text</a></p>');
    });
...
//# sourceMappingURL=LinkPluginTest.js.map