...
UnitTest.asynctest('tinymce.lists.browser.BackspaceDeleteTest', function () {
    ...
    suite.test('Backspace at LI selected with triple-click in UL', function (editor) {
        ...
        editor.plugins.lists.backspaceDelete();
        LegacyUnit.equal(LegacyUnit.trimBrs(editor.getContent()), '<ul>' +
            '<li>b' +
            '<ul>' +
            '<li>c</li>' +
            '<li>d</li>' +
    ...
    suite.test('Backspace at partially selected list', function (editor) {
        editor.getBody().innerHTML = LegacyUnit.trimBrs('<p>abc</p>' +
            '<ul>' +
            '<li>a</li>' +
            '<li>b' +
            '<ul>' +
        ...
        editor.plugins.lists.backspaceDelete();
        LegacyUnit.equal(LegacyUnit.trimBrs(editor.getContent()), '<p>ab</p>' +
            '<ul>' +
    ...
    TinyLoader.setup(function (editor, onSuccess, onFailure) {
        ...
        content_style: '.mce-content-body { line-height: normal; }',
        skin_url: '/project/js/tinymce/skins/lightgray'
    }, success, failure);
});
//# sourceMappingURL=BackspaceDeleteTest.js.map