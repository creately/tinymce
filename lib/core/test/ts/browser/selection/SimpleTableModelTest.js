...
UnitTest.asynctest('browser.tinymce.core.selection.SimpleTableModel', function () {
    ...
    var cFromDomSubSection = function (html, startPath, endPath) {
        return Chain.binder(function (_) {
            ...
            return SimpleTableModel.subsection(SimpleTableModel.fromDom(tableElm), startElm, endElm).fold(Fun.constant(Result.error('Failed to get the subsection')), Result.value);
        });
    };
...
//# sourceMappingURL=SimpleTableModelTest.js.map