...
UnitTest.asynctest('browser.tinymce.core.html.EntitiesTest', function () {
    ...
    suite.test('encodeRaw', function () {
        ...
        LegacyUnit.equal(Entities.encodeRaw('<>"\'&\u00e5\u00e4\u00f6\u0060', true), '&lt;&gt;&quot;\'&amp;\u00e5\u00e4\u00f6&#96;', 'Raw encoding attribute');
    });
    ...
    suite.test('encodeNumeric', function () {
        LegacyUnit.equal(Entities.encodeNumeric('<>"\'&\u00e5\u00e4\u00f6\u03b8\u2170\ufa11'), '&lt;&gt;"\'&amp;&#229;&#228;&#246;&#952;&#8560;&#64017;', 'Numeric encoding text');
        LegacyUnit.equal(Entities.encodeNumeric('<>"\'&\u00e5\u00e4\u00f6', true), '&lt;&gt;&quot;\'&amp;&#229;&#228;&#246;', 'Numeric encoding attribute');
    });
    suite.test('encodeNamed', function () {
        LegacyUnit.equal(Entities.encodeNamed('<>"\'&\u00e5\u00e4\u00f6'), '&lt;&gt;"\'&amp;&aring;&auml;&ouml;', 'Named encoding text');
        LegacyUnit.equal(Entities.encodeNamed('<>"\'&\u00e5\u00e4\u00f6', true), '&lt;&gt;&quot;\'&amp;&aring;&auml;&ouml;', 'Named encoding attribute');
        LegacyUnit.equal(Entities.encodeNamed('<>"\'\u00e5\u00e4\u00f6', false, { å: '&aring;' }), '&lt;&gt;"\'&aring;\u00e4\u00f6', 'Named encoding text');
        LegacyUnit.equal(Entities.encodeNamed('<>"\'\u00e5\u00e4\u00f6', true, { å: '&aring;' }), '&lt;&gt;&quot;\'&aring;\u00e4\u00f6', 'Named encoding attribute');
    });
    suite.test('getEncodeFunc', function () {
        ...
        LegacyUnit.equal(encodeFunc('<>"\'&\u00e5\u00e4\u00f6', true), '&lt;&gt;&quot;\'&amp;&aring;&#228;&#246;', 'Named+numeric encoding attribute');
    ...
    suite.test('decode', function () {
        LegacyUnit.equal(Entities.decode('&lt;&gt;&quot;&#39;&amp;&aring;&auml;&ouml;&unknown;'), '<>"\'&\u00e5\u00e4\u00f6&unknown;', 'Decode text with various entities');
...
//# sourceMappingURL=EntitiesTest.js.map