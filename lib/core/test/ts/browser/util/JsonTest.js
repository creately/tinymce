...
UnitTest.asynctest('browser.tinymce.core.util.JsonTest', function () {
    ...
    suite.test('serialize', function () {
        LegacyUnit.equal(Json.serialize({
            arr1: [1, 2, 3, [1, 2, 3]],
            bool1: true,
            float1: 3.14,
            int1: 123,
    ...
    suite.test('parse', function () {
        LegacyUnit.equal(Json.parse('{"arr1":[1,2,3,[1,2,3]],"bool1":true,"float1":3.14,"int1":123,"null1":null,' +
            '"obj1":{"key1":"val1","key2":"val2"},"str1":"abc\\u00c5123"}').str1, 'abc\u00c5123');
    });
