...
UnitTest.asynctest('browser.tinymce.core.CaretPositionTest', function () {
    ...
    suite.test('fromRangeStart', function () {
        ...
        CaretAsserts.assertCaretPosition(CaretPosition.fromRangeStart(createRange(getRoot().firstChild, 1)), CaretPosition(getRoot().firstChild, 1));
    });
    suite.test('fromRangeEnd', function () {
        ...
        CaretAsserts.assertCaretPosition(CaretPosition.fromRangeEnd(createRange(getRoot().firstChild, 0, getRoot().firstChild, 1)), CaretPosition(getRoot().firstChild, 1));
    });
...
//# sourceMappingURL=CaretPositionTest.js.map