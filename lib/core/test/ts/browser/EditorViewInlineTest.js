...
UnitTest.asynctest('browser.tinymce.core.EditorViewInlineTest', function () {
    ...
    var sTestIsXYInContentArea = function (editor, deltaX, deltaY) {
        return Step.sync(function () {
            ...
            Assertions.assertEq('Should be inside the area since the scrollbars are excluded', true, EditorView.isXYInContentArea(editor, rect.right - 25 - deltaX, rect.bottom - 25 - deltaY));
            Assertions.assertEq('Should be outside the area since the cordinate is on the scrollbars', false, EditorView.isXYInContentArea(editor, rect.right - 5 - deltaX, rect.bottom - 5 - deltaY));
        });
    };
...
//# sourceMappingURL=EditorViewInlineTest.js.map