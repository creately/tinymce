...
UnitTest.asynctest('browser.tinymce.core.dom.NodePathTest', function () {
    ...
    suite.test('resolve', function () {
        ...
        LegacyUnit.equalDom(NodePath.resolve(getRoot(), NodePath.create(getRoot(), getRoot().firstChild.firstChild)), getRoot().firstChild.firstChild);
        LegacyUnit.equalDom(NodePath.resolve(getRoot(), NodePath.create(getRoot(), getRoot().firstChild.lastChild.lastChild)), getRoot().firstChild.lastChild.lastChild);
    });
    viewBlock.attach();
...
//# sourceMappingURL=NodePathTest.js.map