...
UnitTest.asynctest('browser.tinymce.core.ForceBlocksTest', function () {
    ...
    suite.test('Textnodes with only whitespace should not be wrapped new paragraph', function (editor) {
    ...
    suite.test('Do not wrap whitespace textnodes between inline elements', function (editor) {
...
//# sourceMappingURL=ForceBlocksTest.js.map