...
UnitTest.test('Atomic Test: styles.StyleConversionsTest', function () {
    ...
    check('Input with one flat item', {
        menus: {},
        expansions: {},
        items: [
            { title: 'alpha' }
    ...
    check('Input with three flat items', {
        menus: {},
        expansions: {},
        items: [
            { title: 'alpha' },
    ...
    check('Input with three items, and an empty menu in the middle', {
        menus: {
            beta: []
        },
        expansions: {
    ...
    check('Input with three items, and a menu with a single item in the middle', {
        menus: {
            beta: [
                { title: 'beta-1' }
            ]
    ...
    check('Input with three items, and a menu with three items in the middle', {
        menus: {
            beta: [
                { title: 'beta-1' },
                { title: 'beta-2' },
    ...
    check('Input with three items, and a menu (beta) with three items (beta1,2,3) in the middle' +
    ...
    check('Input with three items, and a menu with three items (beta-1,2,3) in the middle' +
...
//# sourceMappingURL=StyleConversionsTest.js.map